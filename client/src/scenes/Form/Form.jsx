...
const recordSchema = yup.object().shape({
  ...
  lastName: yup.string().require,
  age: yup.string().required("required"),
  sex: yup.string().required("required"),
  health_record_no: yup.string(),
...
const Form = () => {
  ...
  const handleFormSubmit = async (values, onSubmitProps) => {
    ...
    for(let value in values){
      if(value === "previous_glass_prescription_date" || value === "date_of_assessment"){
         formData.append(value, reverseString(values[value]));
         continue;
      }
        ...
        {({
          ...
          <form onSubmit={handleSubmit}>
		    ...
		    onBlur={handleBlur}
                    noValidate
                    onChange={handleChange}
		    helperText={!values.date_of_assessmet ? "DD-MM-YYYY" : ""}
            ...
            {previousGlassPrescription ? (
		      ...
		      onBlur={handleBlur}
                      onChange={handleChange}
                      value={values.previous_glass_prescription_date}
                      name="previous_glass_prescription_date"
                      sx={{ gridColumn: "span 1" }}
                    />
                    <IconButton>
                      <ArrowUpwardOutlined
